...
public class GlobalHandlerException extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorResponseDTO> handlerCustomerAlreadyExists(CardAlreadyExists cardAlreadyExists, WebRequest webRequest) {
		
		ErrorResponseDTO errorResponseDTO = new ErrorResponseDTO(webRequest.getDescription(false), HttpStatus.BAD_REQUEST, cardAlreadyExists.getMessage(), LocalDateTime.now());
